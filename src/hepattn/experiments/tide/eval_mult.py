...
def main():
    ...
    foldlist=[("TIDE_32trk_F32_20250924-T204701","epoch=008-train_loss=0.50040_test_eval.h5")


              
              ]
    
    """("adan","epoch=004-train_loss=4.50495_test_eval.h5"),
              ("addmultloss","epoch=005-train_loss=0.00004_test_eval.h5"),
              ("big_posenc_rad","epoch=003-train_loss=0.97229_test_eval.h5"),
              ("big_rff_allpos","epoch=003-train_loss=1.69316_test_eval.h5"),
              ("GLS","epoch=005-train_loss=-113.47095_test_eval.h5"),
              ("rope_enc_mult","epoch=004-train_loss=9.92188_test_eval.h5"),
              ("rope_sep","epoch=004-train_loss=1.11565_test_eval.h5"),
              ("rope4d","epoch=005-train_loss=0.97230_test_eval.h5"),
              ("sophia_posenc","epoch=007-train_loss=0.90081_test_eval.h5")"""

    for (folder, file_name) in foldlist:
