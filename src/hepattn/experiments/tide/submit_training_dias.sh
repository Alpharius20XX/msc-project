...
PYTORCH_CMD="python src/hepattn/experiments/tide/main.py fit --config logs/addmultloss/config.yaml --ckpt_path logs/addmultloss/ckpts/epoch=006-train_loss=0.00013.ckpt"

# Pixi commnand that runs the python command inside the pixi env
PIXI_CMD="pixi run $PYTORCH_CMD"

#PIXI_CMD2="pixi add setuptools"
