...
PYTORCH_CMD="python src/hepattn/experiments/tide/main.py test --config logs/TIDE_32trk_F32_20250709-T170659/config.yaml --ckpt_path logs/TIDE_32trk_F32_20250709-T170659/ckpts/epoch=006-train_loss=5.90920.ckpt --data.num_workers 0"  #--trainer.default_root_dir logs/test_output_dir
